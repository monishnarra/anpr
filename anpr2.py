...
image_path = "{}/{}".format(images_dir, "car5.jpg")
...
cv2.imwrite(r"C:\Users\Monish Narra\Desktop\project\anpr\data\blr.png", laplacian)
...
cv2.imwrite(r"C:\Users\Monish Narra\Desktop\project\anpr\data\plate.png", plate)
